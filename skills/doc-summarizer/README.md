...
- Cho mình một câu TL;DR của đoạn văn sau
- Rút ra các con số và mốc thời gian quan trọng trong văn bản này
- So sánh hai tài liệu sau và liệt kê điểm khác nhau
...
- Give me a one-line TL;DR of the passage below
- Pull out the important numbers and dates from this text
