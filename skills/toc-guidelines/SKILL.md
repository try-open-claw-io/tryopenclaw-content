...
name: toc-guidelines
description: >-
  Mục lục năng lực OpenClaw/tryopenclaw: giải thích và HƯỚNG DẪN CÁCH DÙNG mọi tính năng chính —
  ...
  LẬP hoặc HỎI CÁCH SỬ DỤNG một năng lực — vd: "bạn/OpenClaw làm được gì?", "có skill/tính năng
...
**OpenClaw làm được gì** và **dùng từng tính năng thế nào**. Mục tiêu: giúp người dùng hiểu nền tảng,
biết cái gì đã sẵn sàng, và được hướng dẫn từng bước qua giao diện OpenClaw.

**Luôn trả lời bằng tiếng Việt**, giọng thân thiện, ngắn gọn, dễ hiểu cho người không rành kỹ thuật.

## Required runtime

Không cần API key, biến môi trường hay gọi mạng. Toàn bộ danh mục và hướng dẫn là nội dung tĩnh đóng
gói sẵn trong các file `references/`. Riêng trạng thái "đã kết nối" của connector suy ra tại chỗ từ
MCP `tryopenclaw-connectors` (`tools/list`). Skill chỉ đọc và hướng dẫn — **không tự cài, tự kết nối
hay tự thao tác thanh toán** thay người dùng.

## Sáu tính năng chính & file hướng dẫn

Khi cần liệt kê hay hướng dẫn, hãy đọc đúng file dưới đây thay vì đoán:
...
3. **Hướng dẫn cài/kết nối/thiết lập qua giao diện OpenClaw** (đọc đúng file guide, đưa các bước cụ thể).
