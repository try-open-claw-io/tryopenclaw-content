...
description: >-
  ...
  nối. Trigger cả khi người dùng chỉ NHẮC TỚI "extension" mà chưa hỏi cách cài. KHÔNG dùng khi người dùng chỉ muốn THỰC HIỆN ngay một tác vụ đã có connector/skill phù hợp (soạn/gửi email, gửi tin nhắn,
