...
## Craft email/newsletter (community-distilled)

- **Subject line** — chọn 1 kiểu: curiosity gap, direct benefit ("Cách chốt gấp đôi deal tháng này"), social proof ("[Brand] làm X ra kết quả Y"), urgency, personal ("Hỏi nhanh, [tên]"). Tránh spam words.
- Dòng đầu = hook, KHÔNG "Chào bạn, hy vọng email tìm thấy bạn…".
- **1 email = 1 ý chính.** Đọc mức lớp 5. Mobile-first, đoạn 1-3 câu. Nút CTA + text link. Dòng **P.S.** được đọc nhiều — để hook/proof mạnh ở đó.
- Đủ mục tiêu + nguồn nội dung thì viết luôn bản đầy đủ với `[[LINK: ...]]` placeholder — đừng dừng chỉ để hỏi khi đã đủ để nháp.
