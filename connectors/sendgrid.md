...
name:
  ...
  en: "SendGrid"
description:
  vi: "SendGrid là nền tảng gửi email tự động cho từng giao dịch. Với kết nối này, Agent có thể gửi mail xác nhận đơn, mã OTP và đặt lại mật khẩu cho khách của bạn."
  en: "SendGrid is a platform for automated transactional email. With this connection, the Agent can send order confirmations, OTPs, and password resets to your customers."
