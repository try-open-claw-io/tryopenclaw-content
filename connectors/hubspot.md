...
name:
  ...
  en: "HubSpot"
description:
  vi: "HubSpot là nền tảng CRM cho marketing, bán hàng và chăm sóc khách. Với kết nối này, Agent có thể thêm lead, cập nhật deal, xem pipeline và tra hồ sơ contact cho bạn."
  en: "HubSpot is a CRM platform for marketing, sales, and support. With this connection, the Agent can add leads, update deals, view pipelines, and look up contacts for you."
category: crm-sales
popular: true
howToUse:
  vi:
