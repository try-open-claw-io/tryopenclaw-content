...
name:
  ...
  en: "Intercom"
description:
  vi: "Intercom là nền tảng chat hỗ trợ khách trên web và app. Với kết nối này, Agent có thể xem chat chưa trả lời, trả lời khách, gắn câu mẫu và mở đúng hội thoại cho bạn."
  en: "Intercom is a customer support chat for web and apps. With this connection, the Agent can view unread chats, reply to customers, apply saved replies, and open the right conversation for you."
category: support
popular: true
howToUse:
  vi:
