...
name:
  ...
  en: "Twilio"
description:
  vi: "Twilio là nền tảng gửi SMS và gọi điện tự động. Với kết nối này, Agent có thể gửi SMS, mã OTP, tin xác nhận và thực hiện cuộc gọi tự động đến người nhận."
  en: "Twilio is a platform for SMS and automated voice calls. With this connection, the Agent can send SMS, OTP codes, confirmation texts, and place automated calls to recipients."
